  ...
  return (
    ...
    >
      <div className="relative h-full w-[85%] sm:w-[531px] md:w-[637px] lg:w-[849px] xl:w-[1062px] 2xl:w-[1274px]">
        {/* Name */}
        <motion.div
          initial={{ x: -200, opacity: 0, zIndex: 20 }}
          animate={{ x: 0, opacity: 1, zIndex: 20 }}
          transition={{ duration: 0.5, delay: 0 }}
          className="absolute left-[50%] translate-x-[-50%] md:left-[8%] md:translate-x-0 top-[22%] lg:top-[63%] lg:translate-y-[-63%] text-[96px]/28 md:text-[128px]/28 font-semibold text-highlight text-center w-fit h-fit md:z-20"
        >
          <div>Matthew</div>
        ...
        {/* Short Description */}
        <motion.div
          initial={{ x: 200, opacity: 0, zIndex: 50 }}
          animate={{ x: 0, opacity: 1, zIndex: 50 }}
          transition={{ duration: 0.5, delay: 0 }}
          className="flex flex-col gap-2 absolute right-[50%] translate-x-[50%] lg:right-[10%] lg:translate-x-0 xl:right-[20%] top-[60%] lg:top-[75%] lg:translate-y-[-75%] text-white w-[280px] z-50 p-2 bg-foreground/80 lg:bg-none rounded-md"
        >
